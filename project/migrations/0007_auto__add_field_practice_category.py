...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Practice.category'
        db.add_column(u'project_practice', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categories.Category'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Practice.category'
        db.delete_column(u'project_practice', 'category_id')
